...
from get_cores.get_leaf_core import get_leaf_core
...
SUPPORTED_CORES = ["vanilla", "paper", "purpur", "velocity", "fabric", "leaf"]
...
elif core_type == SUPPORTED_CORES[5]:
	asyncio.run(get_leaf_core(game_verison))
else:
